                          ...
                          <div className="mail_click">
                            <div className="mail_click_box">
                              ...
                              <div className="mail_click_box_content">
                                ...
                                <span>{((data?.labels_value[item] / data?.email_sent) * 100)==100
                                ?100 + "%"
                              :((data?.labels_value[item] / data?.email_sent) * 100)==0
                              ?0
                              :((data?.labels_value[item] / data?.email_sent) * 100)?.toFixed(2)+"%"
