            ...
            <div className="form-inline row justify-content-between align-items-center">
              <div className="form-group">
                ...
                {formik.touched.EventTitle && formik.errors.EventTitle ? (
                   <div className="error" style={{ color: "red" }}>{formik.errors.EventTitle}</div>
                ) : null}
              </div>
            </div>
            ...
            <div className="form-group col-12 col-md-12">
              ...
              ></textarea>
               {formik.touched.Description && formik.errors.Description ? (
                ...
                <Button class="btn btn-primary btn-bordered" variant="danger" onClick={() => { setSpeakerName([{ name: "", email: "" }]); setSpeakerErr([{ name: "", email: "" }]);setModalShow(false);}}>
                  Close     
                </Button>
