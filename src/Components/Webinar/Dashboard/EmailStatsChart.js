...
const EmailStatsChart = (props) => {
    ...
    const [options_ch, setOptions_ch] = useState({
      ...
      const handleGetEventlist = () => {
        ...
        ExportApi.getEmailStatsChart(props.eventid,props.templateId).then((resp) => {
          if (resp.ok) {
  ...
  return (
    <div>
        {data? <div className="chart-description" style={{paddingTop:"70px"}}>
     ...
     {console.log(options_ch)}
        ...
        {options_ch.xAxis.categories.length>0?<div className="chart-description-view">
