                        ...
                        <div className="reheasal_info_inside">
                          <div className="reheasal-box">
                            <h4 className="reheasal-box-title">
                              Select the rehearsal information.
                            </h4>
                            <div key={i}>
                        ...
                        "required"
                                ...
                                <fieldset class="border p-2">
                                  {val.invites_data.map((malti, index) => (
                                    ...
                                    >
                                      <label>
                                        Enter the speaker’s information's
                                      </label>
                                ...
                                <div className="title_create">
                                  <p>
                                    Click on invitation Email to customize the
                                    email
                                  </p>
                                  <button>
                                    <Link to="/webinar/customizerehearsalinvites">
                                      invitation Email
                                    </Link>{" "}
                                  </button>
                                </div>
