        ...
        {RehearsaltData ? (<>
           ...
           <div className="reheasal_info">
             ...
             <div className="reheasal-box">
               <h4 className="reheasal-box-title">The rehearsal information :</h4>
            <div key={i}>
            <fieldset className="reheasal-box-first">
            <h6>{val.title} :</h6>
                <Row>
                    <Col>
                    <p><span>Date |</span> {val.date}</p>
                    <p><span>Timezone |</span> {val.timezone}</p>
                    </Col>
                    <Col>
                    <p><span>Start Time |</span> {val.start_time}</p>
                    <p><span>End Time |</span> {val.end_time}</p>
                    </Col>
                </Row>
            </fieldset>
