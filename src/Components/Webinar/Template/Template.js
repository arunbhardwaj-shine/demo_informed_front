        ...
        <section className="select-mail-template">
          <div className="row select-mail-template-slider">
            ...
            >
              ...
              <Modal.Body>
                <h6>
                  The Delete action will delete the HCP from your account
                  entirly
                </h6>
              </Modal.Body>
              <Modal.Footer>
                  ...
                  <div className="form-inline row justify-content-end align-items-center">
                    ...
                    <div className="form-buttons right-side col-12 col-md-5">
                      ...
                      {is_approved == 1 ? (
                        <button
                          type="button"
                          onClick={() => handleUpdateis_approved(0)}
                        ...
                        <button
                          type="button"
                          onClick={() => handleUpdateis_approved(1)}
                          className="btn btn-primary approved-btn btn-bordered"
                        >
                          Approved
                          {/* <svg
                    ...
                    <div className="tag-lists-view">
                      {Object.values(allTags).map((data,i) => {
                        return (
                            ...
                            <div key={i} onClick={(event) => tagClicked(data)}>
                              {data}
                            </div>
