	        ...
	        <div className="top-header">
				...
				<div class="top-right-action">
					...
					<div className={showfilter ? "filter-by nav-item dropdown highlight" : "filter-by nav-item dropdown"}> 
						<button class="btn btn-secondary dropdown" type="button" id="dropdownMenuButton2">Filter By
							<svg class="filter-arrow" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="dropdown-menu filter-options" aria-labelledby="dropdownMenuButton2" onClick={() => setShowFilter((showfilter) => !showfilter)}>
							<h4>Filter By</h4>
							<div class="accordion accordion-flush">
								<div class="card accordion-item">
									<h2 class="card-header accordion-header">
										<button type="button" aria-expanded="true" class="accordion-button">Name</button>
									</h2>
									<div class="accordion-collapse collapse show">
										<div class="card-body accordion-body">
											<ul>
												<li>
													<label class="select-multiple-option">
														<input type="checkbox" id="custom-checkbox-name-0" name="names[]" value="First test list" />
														First test list<span class="checkmark"></span>
													</label>
												</li>
												<li>
													<label class="select-multiple-option">
														<input type="checkbox" id="custom-checkbox-name-1" name="names[]" value="Resend" />
														Resend <span class="checkmark"></span>
													</label>
												</li>
												<li>
													<label class="select-multiple-option">
														<input type="checkbox" id="custom-checkbox-name-2" name="names[]" value="Test 90" />
														Test 90<span class="checkmark"></span>
													</label>
												</li>
											</ul>
										</div>
