											...
											<div class="col d-flex align-items-center justify-content-end">
												<div class="mail-preview-action">
													<div class="hcp-new-user">
														<button class="btn btn-outline-primary btn-filled" data-bs-toggle="modal" data-bs-target="#modal-add"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
								 ...
								 <div class="mailbox-table">
								   <table>
									 <tbody>
									   {/* <tr>
										 <th>Email</th>
										 <td contenteditable="true">bab</td>
									   </tr> */}
									   <tr>
										 <th>Country</th>
