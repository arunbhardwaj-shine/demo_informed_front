      ...
      <Row>
        ...
        <Modal className="modal send-confirm" id="delete-confirm" show={modalShow} size="sm" aria-labelledby="contained-modal-title-vcenter" centered >
          ...
          <Modal.Body>
            ...
            <div className="modal-buttons">
              <Button type="button" className="btn-bordered" onClick={()=>{setModalShow(false)}}>Cancel</Button>
              <Button type="button" className="btn-filled" onClick={()=>{ handleBlock(); setTimeout(() => { setModalShow(false);}, 1000); }}>Block</Button>
            </div>                      
          </Modal.Body>
        </Modal>
        ...
        <Modal className="modal send-confirm" id="delete-confirm" show={modalShow1} size="sm" aria-labelledby="contained-modal-title-vcenter" centered >
          ...
          <Modal.Body>
            ...
            <div className="modal-buttons">
              <Button  className="btn-filled" onClick={()=>{handleDeleteData();setModalShow1(false)}}>Delete</Button>
              <Button  className="btn-bordered" onClick={()=>{setModalShow1(false)}}>Close</Button>
            </div>
          </Modal.Body>
        </Modal>
      </Row>
