        ...
        <div class="top-header">
            ...
            <div class="top-right-action">
                ...
                <form className="d-flex">
                  <input placeholder="By name or email" className="form-control me-2" type="search" placeholder="Search" aria-label="Search" onChange={(e) => { handleGetReadersSearch(e.target.value); setSearch(e.target.value); }} />
                      ...
                      <path d="M15.8045 14.862L11.2545 10.312C12.1359 9.22334 12.6665 7.84 12.6665 6.33334C12.6665 2.84134 9.82522 0 6.33325 0C2.84128 0 0 2.84131 0 6.33331C0 9.82531 2.84132 12.6667 6.33328 12.6667C7.83992 12.6667 9.22325 12.136 10.3119 11.2547L14.8619 15.8047C14.9919 15.9347 15.1625 16 15.3332 16C15.5039 16 15.6745 15.9347 15.8045 15.8047C16.0652 15.544 16.0652 15.1227 15.8045 14.862ZM6.33328 11.3333C3.57597 11.3333 1.33333 9.09066 1.33333 6.33331C1.33333 3.57597 3.57597 1.33331 6.33328 1.33331C9.0906 1.33331 11.3332 3.57597 11.3332 6.33331C11.3332 9.09066 9.09057 11.3333 6.33328 11.3333Z" fill="#97B6CF"/>
							...
							<div class="filter-by nav-item dropdown">
							  <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
								Filter By <svg class="filter-arrow" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<svg class="close-arrow" width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
							  ...
							  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
								<li><a class="dropdown-item" href="#">Filter1 <img src="assets/images/filter-close.svg" alt="Close-filter"/></a></li>
								<li><a class="dropdown-item" href="#">Filter2 <img src="assets/images/filter-close.svg" alt="Close-filter"/></a></li>
								<li><a class="dropdown-item" href="#">Filter3 <img src="assets/images/filter-close.svg" alt="Close-filter"/></a></li>
							  </ul>
							</div>
              <div className="clear-search">
              <button className="btn btn-outline-primary" type="submit"><CsvDownload data={NewData}>Excel Download
