  ...
  return (
    <>
        ...
        <div className="right-sidebar col">
                            ...
                            <ul className="hcp-table-content-right">
                                <div className="user-type-action">
                                    <button title="Edit"  onClick={(e) => {
                                        ...
                                        <img alt="edit" src={path_image + "edit-btn.png"} />
                                    </button>
                                    ...
                                    <button title="Delete"  onClick={(e) => {
                                        ...
                                        <img alt="Delete" src={path_image + "delete-btn.png"} />
                                    </button>
            ...
            <Modal show={modalShow} id="template_preview" onHide={() => { setModalShow(false); }} >
                <Modal.Header closeButton>
                    <h4>Preview Page </h4>
                </Modal.Header>
                <Modal.Body>
                    <iframe src={`${BaseUrlImage}/SH2022/index${format}.php?event=${eventCode}&mode=${mode}`}></iframe>
                </Modal.Body>
                <Modal.Footer>
                    ...
                    <div className="modal-buttons">
                        ...
                        {registrationPageList === undefined ? null : <button
                            ...
                            onClick={() => { 
                                setShow(true);
                                //setModeShow(false); 
                                setRegistrationPageIdCopy(localStorage.getItem("Virtual_page_id"));
            ...
            <Modal.Body>
                ...
                <div className="modal-buttons">
                    <button
                        ...
                        className="btn btn-primary btn-filled"
                        data-bs-dismiss="modal"
                        onClick={() => {handleGetRegistrationDelete();}}
                        >
                        Yes Please!
                    </button>
                    <button
