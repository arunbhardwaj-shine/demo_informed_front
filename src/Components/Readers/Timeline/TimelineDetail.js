...
const data = [
  {
    ...
    chapter:[
      {
       chapter:"Chapter 1",
       markimage:"https://docintel.s3-eu-west-1.amazonaws.com/ebook/pdftoimage/Haematology_Octapharma/3681/ios_page1.png"
      },
       {
  ...
  },
  {
    itemdetail:"Web Details:",
     ...
     activity:"Activity: Login to docintel app",
      ...
      {
      chapter:"Chapter 1",
       markimage:"https://docintel.s3-eu-west-1.amazonaws.com/ebook/pdftoimage/Haematology_Octapharma/3755/ios_page1.png"
      },
       {
       markimage:"https://docintel.s3-eu-west-1.amazonaws.com/ebook/pdftoimage/Haematology_Octapharma/3755/ios_page2.png"
       },
       {
            ...
            data.map((item,index) =>(
                <div key={index} className="vertical-timeline vertical-timeline--animate">
                  <div className="vertical-timeline-element--work vertical-timeline-element">
                    <span className="vertical-timeline-element-icon bounce-in" style={{background: "rgb(0, 74, 137)", color: "rgb(0, 74, 137)"}}></span>
                    <div className="vertical-timeline-element-content bounce-in" style={{background: "rgb(255, 255, 255)", color: "rgb(0, 74, 137)"}}>
                        ...
                        <div className="vertical-timeline-title">
                          <h6 className="vertical-timeline-element-title">{item.itemdetail}</h6>
                        </div>
                        <div className="vertical-timeline-details">
                          <h6 className="vertical-timeline-time">{item.time}</h6>
                          <h6 className="vertical-timeline-activity">{item.activity}</h6>
                          <h6>{item.title}</h6>
                        </div>
