  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/pdfviewer"
          element={<DefaultLayout component={PdfViewer} />}
        />
        ...
        <Route
          path="/all-events"
          element={<LoginLayout component={AllEvents} />}
        />
        <Route
          path="/spc-create"
        ...
        />
        <Route path="/polls" element={<LoginLayout component={Polls} />} />
        {/* <Route
        ...
        <Route
          ...
          element={
            <LoginLayout component={WebinarSelectSmartListUsersLayout} />
          }
        />
        <Route
        ...
        />
        <Route path="/IRTRole" element={<LoginLayout component={IRTRole} />} />
        <Route
          path="/EmailList"
        ...
        <Route path="/survey/8check-data" element={<Check8SurveyData />} />
        <Route
