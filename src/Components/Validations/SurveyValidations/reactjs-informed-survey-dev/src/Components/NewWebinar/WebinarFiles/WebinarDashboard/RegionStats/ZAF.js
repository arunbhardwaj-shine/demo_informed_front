...
const ZAF = () => {
  ...
  return (
    <>
      <div>
        <p>Total number of attendees in this region is 2</p>
        <p>0.97% (2/207) of total attendees</p>
        <p>0.13% (2/1560)of total registered</p>
      </div>
      <div>
