...
const EE_CIS = () => {
  ...
  return (
    <>
    <div>
        <p>Total number of attendees in this region is 7</p>
        <p>3.38% (7/207) of total attendees</p>
        <p>0.45% (7/1560) of total registered</p>
    </div>
      <div>
