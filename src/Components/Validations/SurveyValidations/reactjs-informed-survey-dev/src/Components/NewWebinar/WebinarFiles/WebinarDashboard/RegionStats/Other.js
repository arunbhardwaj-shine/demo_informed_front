...
const Other = () => {
  ...
  return (
    <>
      <div>
        <p>Total number of attendees in this region is 4</p>
        <p>1.93% (4/207) of total attendees</p>
        <p>0.26% (4/1560) of total registered</p>
      </div>
      <div>
