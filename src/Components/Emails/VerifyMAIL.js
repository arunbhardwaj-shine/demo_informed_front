						...
						<div className="row justify-content-end align-items-center">
							...
							<div className="col-12 col-md-2">
							  <div className="header-btn">
								...
								<button className="btn btn-primary btn-filled next">Create</button>
							  </div>
							</div>
						 </div>
					</div>
							...
							<div className="row">
								<div className="col-12 verify-left">
									...
									<div className="verify-email-detail">
										<h4>Email Details</h4>
										<h6><strong>Campaign Title | </strong>Title of the campaign</h6>
										<h6><strong>Creator | </strong>Creator name</h6>
										<h6><strong>Tags | </strong><ul>
											...
											<li className="list3">tag3 <img src={path_image + "filter-close.svg"} alt="Close-filter"/></li>
									...
									<div className="mail-recipt">
										...
										<div className="col-12 col-md-5 mail-recipt-left">
											<h6>The recipients <span>| 1</span></h6>
									...
									<div className="mailbox-table">
										<table>
											<tbody>
												...
												<tr><th>Readers</th><td>CIS Reader</td></tr>
												<tr><th>IBU</th><td>Haematology</td></tr>
												<tr><th>Product</th><td>Name of the product</td></tr>
												<tr><th>Country</th><td>Countries names</td></tr>
												<tr><th>Registered</th><td>No</td></tr>
												<tr><th>Created By</th><td><span>Creator’s name</span></td></tr>
											</tbody>
										</table>
									</div>
									
									<div className="mail-time"><span>Nov 18 | 9:00 AM</span></div>
									<div className="smart-list-added-user"><img src="assets/images/smartlist-user.svg" alt="User icon"/>203</div>
								...
								<div className="col-12 verify-right">
									<div className="preview_mail">
										...
										<p>Email Subject</p>
										<div className="preview-mail-box">
