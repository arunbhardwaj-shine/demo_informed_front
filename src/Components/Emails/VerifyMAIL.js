...
const VerifyMAIL = (props) => {
  ...
  const createEmail = async () => {
    setIsOpen(true);
    let finalTags = props.tags.map((tags) => {
    ...
    const body = {
      ...
      creator: props.emailCreator,
      campaign_name: props.emailCampaign,
      tags: finalTags,
      campaign_id: "",
      //   campaign_data: {
      //     user_list: [""],
      //     template_id: ,
      //   },
      campaign_data: { user_list: user_list, template_id: props.templateId },
    };
                          ...
                          <div className="mailbox-table">
                            <table>
                              <tbody>
                                <tr>
                                  <th>Contact Type</th>
                                  <td>Smart list members type</td>
                                </tr>
                                <tr>
                                  <th>Speciality</th>
                                  <td>Speciality of the smart list members</td>
                                </tr>
                                <tr>
                                  <th>Readers</th>
                                  <td>CIS Reader</td>
