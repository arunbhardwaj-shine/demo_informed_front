              ...
              return (
                ...
                >
                  <div className="mail-top-title">
                    <span>{data.status == 2 ? "Draft" : "Approved Draft"}</span>
                  </div>
                    ...
                    {data.status == 1 ? (
                      <div className="mailbox-buttons">
                        <div className="send_new">
                          <button className="btn btn-primary btn-filled send-new">
                            Send New
                          </button>
                        </div>
                        <div className="mailbox-buttons-list">
                          <button className="btn btn-primary btn-bordered send">
                            Resend
                          </button>
                          <button className="btn btn-primary btn-filled edit">
                            View
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="mailbox-buttons">
                        <button className="btn btn-primary send btn-bordered">
                          Send
                        </button>
                        <button
