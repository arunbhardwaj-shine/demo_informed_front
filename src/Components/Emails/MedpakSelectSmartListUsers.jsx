...
const MedpakSelectSmartListUsers = (props) => {
  const accountMapping = {
    ...
    "HPW6EwQy6v8VrfnMsjz8tg==": 2147634806,
  };
  ...
  const [hpc, setHpc] = useState([
    {
      ...
      country: "",
      countryIndex: "",
      role: isLikeRdAccount ? irtRole?.[0]?.value : "",
      optIrt: isLikeRdAccount ? "yes" : "",
      institutionType: "",
    },
  ]);
  ...
  const readersAdded = (reader, i) => {
    ...
    setNewlyAddedCountryWiseData((oldData) => ({
      ...resultObject,
      ...oldData,
    }));
  ...
  const editing = (profile_id, profile_user_id, email, jobTitle, company) => {
    if (editable != 0) {
  ...
  const saveEditClicked = async () => {
    ...
    if (editableData.length > 0) {
      editableData.map((data) => {
        ...
        const contact_type_edit = !isLikeRdAccount
          ? document.getElementById("field_contact_type" + data.profile_user_id)
              .value
          : "";
    ...
    if (activeManual == "active") {
      ...
      const status = body.data.map((data, index) => {
        if (
          ...
          if (data.first_name == "" && isLikeRdAccount) {
            setValidationError({
          ...
          if (data.last_name == "" && isLikeRdAccount) {
            setValidationError({
          ...
          if (data.institution_type == "" && isLikeRdAccount) {
            setValidationError({
          ...
          if (data.country == "" && isLikeRdAccount) {
            setValidationError({
          ...
          <div className="row">
                ...
                <div className="col-12 col-md-9">
                  <ul className="tabnav-link">
                    ...
                    <li className="active active-main">
                      <Link to="/MedpakSelectSmartListUsers">
                        Verify Your List
                      </Link>
                    </li>
            ...
            <section className="search-hcp">
              <div className="result-hcp-table">
                ...
                <Accordion>
                  {Object.keys(newlyAddedCountryWiseData)?.length
                    ? Object.keys(newlyAddedCountryWiseData)?.map(
                        (country, index) => {
                          return (
                            <>
                                    ...
                                    <div className="selected-hcp-list">
                                      <table className="table">
                                        ...
                                        <tbody>
                                          ...
                                          {/* {Object.keys(newlyAddedCountryWiseData)?.length ? Object.keys(newlyAddedCountryWiseData)?.map((newCountry, key) => {
                                                                                return (
                                                                                    <> */}
        ...
        >
          <div className="modal-header">
            <h5 className="modal-title" id="staticBackdropLabel">
              {isLikeRdAccount ? "Add New User +" : "Add New HCP"}
            </h5>
            <button
              onClick={() => {
                setIsOpenAdd(false);
                          ...
                          <div className="form_action">
                            <div className="row">
                              ...
                              <div className="col-12 col-md-6">
                                <div className="form-group">
                                  <label htmlFor="">
                                    Country {isLikeRdAccount && <span>*</span>}{" "}
                                  </label>
                                  {val?.optIrt == "yes" ? (
                                    <>
                                      <Select
