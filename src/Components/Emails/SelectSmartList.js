						...
						<div className="select-smart-list">
							<div className="table-title">
								<div className="create-smart-list">
									<p>If you do not have a smart list for the HCPs group, you can :</p>
									<button className="btn btn-primary btn-bordered">Create new smart list</button>
                  ...
                  return (
                        ...
                        <div className="smartlist-view email_box">
                          <div className="mail-box-content">
                            <h5>{template.name}</h5>
                            <div className="select-mail-option" onClick={()=>handleSelect(template)}>
                            ...
                            <div className="mailbox-table">
                              <table>
                                <tbody>
                                  <tr><th>Contact Type</th><td>{template.contact_type ==="" ? "N/A" : template.contact_type }</td></tr>
                                  <tr><th>Speciality</th><td>{template.contact_type ==="" ? "N/A" : template.contact_type }</td></tr>
                                  <tr><th>Readers</th><td>{template.contact_type ==="" ? "N/A" : template.contact_type }</td></tr>
                                  <tr><th>IBU</th><td>{template.contact_type ==="" ? "N/A" : template.contact_type }</td></tr>
                                  <tr><th>Product</th><td>{template.product ==="" ? "N/A" : template.product }</td></tr>
                                  <tr><th>Country</th><td>{template.contact_type ==="" ? "N/A" : template.contact_type }</td></tr>
                                  <tr><th>Registered</th><td>{template.country ==="" ? "N/A" : template.country }</td></tr>
                                  <tr><th>Created By</th><td><span>{template.contact_type ==="" ? "N/A" : template.contact_type }</span></td></tr>
                                </tbody>
                              </table>
                            </div>
