...
const FilterSegment = (props) => {
  ...
  const [selectedreaderselection, setSelectedReaderSelection] = useState('CIS Reader');
  ...
  const applyFilter = async () => {
    ...
    //For Contact Type
    if(typeof(selectedcontacttype) === 'object' && selectedcontacttype.length > 0){
    ...
    //For Speciality
    if(typeof(selectedspeciality) === 'object' && selectedspeciality.length > 0){
    ...
    <>
      ...
      <div className="box">
          <div className="row" id="box_border">
                  ...
                  <ul className="toppings-list">
                      {Object.entries(filters.contact_type).map(([index, item])  => (
                        <li className="left-section">
                            ...
                            />
                            <label htmlFor={`custom-checkbox-contact_type-${index}`}>{item}</label>
                        </li>
                      ))}
                  </ul>
                </div>
              }
              {'speciality' in filters && Object.keys(filters.speciality).length > 0 &&
                <div className="col-sm-2">
                  <p>Speciality</p>
                  <ul className="toppings-list">
                      {Object.entries(filters.speciality).map(([index, item])  => (
                        <li className="left-section">
                            ...
                            />
                            <label htmlFor={`custom-checkbox-speciality-${index}`}>{item}</label>
                        </li>
                      ))}
                  </ul>
                </div>
              }
              {'reader_selection' in filters && Object.keys(filters.reader_selection).length > 0 &&
                <div className="col-sm-2">
                  ...
                  <ul className="toppings-list">
                      {Object.entries(filters.reader_selection).map(([index, item])  => (
                        <li className="left-section">
                            ...
                            />
                            <label htmlFor={`custom-checkbox-reader_selection-${index}`}>{item}</label>
                        </li>
                      ))}
                  </ul>
                </div>
                  ...
                  <ul className="toppings-list">
                      {Object.entries(filters.ibu).map(([index, item])  => (
                        <li className="left-section">
                            ...
                            />
                            <label htmlFor={`custom-checkbox-ibu-${index}`}>{item}</label>
                        </li>
                      ))}
                  </ul>
                </div>
                  ...
                  <ul className="toppings-list">
                      {Object.entries(filters.product).map(([index, item])  => (
                        <li className="left-section">
                            ...
                            />
                            <label htmlFor={`custom-checkbox-product-${index}`}>{item}</label>
                        </li>
                      ))}
                  </ul>
                </div>
                  ...
                  <ul className="toppings-list">
                      {Object.entries(filters.country).map(([index, item])  => (
                        <li className="left-section">
                            ...
                            />
                            <label htmlFor={`custom-checkbox-country-${index}`}>{item}</label>
                        </li>
                      ))}
                  </ul>
                </div>
                  ...
                  <ul className="toppings-list">
                      {filters.consent_type.map((item,index) => (
                        <li className="left-section">
                            ...
                            />
                            <label htmlFor={`custom-checkbox-consent_type-${index}`}>{item}</label>
                        </li>
                      ))}
                  </ul>
                </div>
                  ...
                  <ul className="toppings-list">
                      {Object.entries(filters.articles).map(([index, item])  => (
                        <li className="left-section">
                            ...
                            />
                            <label htmlFor={`custom-checkbox-articles-${index}`}>{item}</label>
                        </li>
                      ))}
                  </ul>
                </div>
              ...
              <div className="row">
                <button className="btn-cancel" onClick={clearFilter}>Clear</button>
                <button className="btn-nxt" onClick={applyFilter}>Apply</button>
              </div>
          </div>
      </div>
      <div className="box mt-2">
          ...
          <div className="row" id="box_border">
          {updateflag > 0 ?
            typeof(selectedcountry) === 'object' && selectedcountry.length > 0 ?
          ...
          {updateflag > 0 ?
            typeof(selectedcontacttype) === 'object' && selectedcontacttype.length > 0 ?
              <div className="col-md-2">
                <p>contact Type</p>
          ...
          {updateflag > 0 ?
            typeof(selectedspeciality) === 'object' && selectedspeciality.length > 0 ?
              <div className="col-md-2">
                <p>Speciality</p>
          ...
          {updateflag > 0 ?
            typeof(selectedproduct) === 'object' && selectedproduct.length > 0 ?
              <div className="col-md-2">
                <p>Products</p>
          ...
          {updateflag > 0 ?
            typeof(selectedarticles) === 'object' && selectedarticles.length > 0 ?
              <div className="col-md-2">
                <p>Articles</p>
          ...
          {updateflag > 0 ?
            typeof(selectedconsent) === 'object' && selectedconsent.length > 0 ?
              <div className="col-md-2">
                <p>Consent</p>
