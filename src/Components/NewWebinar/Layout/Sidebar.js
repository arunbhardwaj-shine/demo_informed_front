...
const WebinarSidebar = () => {
  ...
  if (
    ...
    location.pathname != "/email-statsss" &&
    location.pathname != "/stats-webinar" &&
    location.pathname != "/auto-mail" &&
    location.pathname != "/event-create" &&
    location.pathname != "/setting-webinar" &&
    location.pathname != "/web-dashboard"
  ) {
      ...
      <div className="left-sidebar">
        <div className="sidebar-menu">
          ...
          <ul>
            ...
            <li
              className={
                location.pathname === "/stats-webinar" && c_id == 0
                  ? "active"
                  : "side_li"
              }
            >
              <Link to={"/stats-webinar"}>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <li
              className={
                location.pathname === "/auto-mail" && c_id == 0
                  ? "active"
                  : "side_li"
              }
            >
            ...
            <li
              className={
                location.pathname === "/event-create" && c_id == 0
                  ? "active"
                  : "side_li"
              }
            >
            ...
            <li
              className={
                location.pathname === "/setting-webinar" && c_id == 0
                  ? "active"
                  : "side_li"
              }
            >
              <Link to={"/setting-webinar"}>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <li
              className={
                location.pathname === "/web-dashboard" && c_id == 0
                  ? "active"
                  : "side_li"
              }
            >
