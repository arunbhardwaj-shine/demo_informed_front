          ...
          <Row>
                              ...
                              <div className="hcp-sort">
                                {sortingCreateCount == 0 ? (
                                  <>
                                    ...
                                    >
                                      Sort Date <img src={path_image + "sort.svg"} alt="Shorting"/>
                                    </button>
                                  </>
                                ) : sortingCreate == 0 ? (
                                  <>
                                ...
                                {sortingCount == 0 ? (
                                  <>
                                    ...
                                    >
                                      Sort Event <img src={path_image + "sort.svg"} alt="Shorting"/>
                                    </button>
                                  </>
                                ) : sorting == 0 ? (
                                  <>
            ...
            <section className="search-hcp smart-list-view event_listing">
              <div className="col email-result-block">
                  <div className="email_box_block add-webinar"  onClick={(e) => handleAddEventClick(e)}>
                  ...
                  </div>
                  {
                            ...
                            <div className="mail-box-content">
                                ...
                                <div className="event-details d-flex justify-content-between">
                                  <div className="time-left">
                                    {
                                      differenceDays(item?.dateStart) == 0 ? "Event Live" :
                                      differenceDays(item?.dateStart) > 0 ? differenceDays(item?.dateStart) + " Days Left" : 
                                      "Event Expire"
                                    }
                                  </div>
                                  <div className="event-date">
                                  {formatDate(item?.dateStart)} | {`${item?.dateStartHour}:${
                                    item?.dateStartMin.length == 1 ? '0'+item?.dateStartMin : item?.dateStartMin
                    ...
                    : 
                    <div class="email_box_block no_found"><p>No Data Found</p></div>
                  }
            </div>
