                        ...
                        <div className="email_box_block" key={index}
                          ...
                          <div className="email_box">
                            <div className="mail-box-content">
                              ...
                              <div className="speaker-name"><span>Speaker</span> {index == 0 ? JSON.parse(rawDescription[index]?.speaker_name)?.map((item, i) => (item?.speakerName)) : rawDescription[index]?.speaker_name ? rawDescription[index]?.speaker_name : "N/A"}</div>
