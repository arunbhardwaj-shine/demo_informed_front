              ...
              <form id="registration_form">
                <div className="row" id="form_upper">
                  <div className="col-sm-12 col-md-12 center-sided">
                    ...
                    <h3>This meeting is for healthcare professionals only.</h3>
                  </div>
       ...
       <a href="#">Change</a>
                ...
                <div className="center-sided-inside">
                  <div className="row">
                    ...
                    <div className="col-sm-12 col-md-12 consent-form-list">
                      ...
                      <div className="btn-group state-dropdown custom-select-menu">
                        <label
                          ...
                          data-language-label=""
                        >
                          <span className="text">Select Your Country</span>
                        </label>
                        <div
                        ...
                        >
                          <div className="dropdown-menu-item">
                            <a className="dropdown-item" data-value="USA">
                    ...
                    <div className="col-sm-12 col-md-12 consent-form-list attend-sec">
                      <p>
                        I will join the Factor VIII Relevance Academy dinner (5
                        <sup>th</sup> Feb) :
                      </p>
                      <ul>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <label htmlFor="travel-arrangement">
                            Have my accommodation organized for 1 night on the 4
                            <sup>th</sup> of Feb
                          </label>
                          <span className="checkmark" />
                        </li>
                        <li>
                          ...
                          <label htmlFor="travel-arranged">
                            Have my accommodation organized for 1 night only on
                            the 5<sup>th</sup> of Feb
                          </label>
                          <span className="checkmark" />
                        </li>
                        <li>
                          ...
                          <label htmlFor="accommodation-arranged">
                            Have my accommodation organized for 2 nights (4
                            <sup>th</sup> and 5<sup>th</sup> Feb)
                          </label>
                          <span className="checkmark" />
                        </li>
                      </ul>
                      ...
                      <ul>
                        <li className="mandatory_col">
                          ...
                          <label htmlFor="being_connected">
                            Being contacted by FVIII Academy organizing team for
                            the purpose of this meeting<span>*</span>
                          </label>
                          <span className="checkmark" />
                        </li>
                        <li>
                          ...
                          <label htmlFor="future_material">
                            Receive future materials from the FVIII Academy
                          </label>
                          <span className="checkmark" />
                        </li>
                      </ul>
          ...
          <div class="change-form"><h6><a href="#">edit opt-in</a></h6></div>
                  ...
                  <div className="footer-sec">
                    <span>
                      * this consent is mandatory in order to register to the
                      event.
                    </span>
                  </div>
                </div>
