                  ...
                  <>
                    <div className="add_hcp_boxes">
                      <div className="form_action">
                        ...
                        { formData.inputType !="label"   && <div className="col-12 col-md-6">
                            <div className="form-group bottom">
                          ...
                          {formData?.option && Object.keys(formData?.option).length > 0
                                  ...
                                  <input
                                    className={
                                      (error?.option && error?.index === index) ||
                                        ...
                                        ? "form-control error"
                                        : formData?.name === "onesource_consent"
                                          ? "form-control disabled"
                                          : "form-control"
                                    }
                                    type="text"
                                    placeholder="Enter option"
                                    value={formData?.option[item]?.optionLabel || ''}
                                    onChange={(e) => handleChange(e, "optionValue", index)}
                                    disabled={formData?.name === "onesource_consent"}
                                  />
                                  {(error?.option && error?.index === index) ||
                                    (error?.options && error?.index === index) ? (
                                    <div className="login-validation">
                                      {error?.option || error?.options}
                                    </div>
                                  ) : null}
