...
const WebinarRegistration = () => {
  ...
  const editExtendedFeildData = (e, index,extIndex) => {
    e.preventDefault();
    setIndex(extIndex);
    // setFieldData(formExtLabel[extIndex]);
    setFieldData(formData?.body[index]?.option[1]?.extension[extIndex])
    setExtensionModal(true);
    console.log(extIndex,'===>index')
    console.log(formExtLabel[extIndex]?.option,'==>formExt')
    console.log(formData?.body[index]?.option[1]?.extension[extIndex],'===?fr')
  }
                                                                ...
                                                                <div>
                                                                  {item?.extension?.map(
                                                                    (
                                                                      ...
                                                                      onClick={(e) =>
                                                                        editExtendedFeildData(e, index,extIndex)
                                                                      }
                                                                    >
                                                                      <svg
