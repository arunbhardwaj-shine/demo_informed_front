                                            ...
                                            >
                                                <div className="form-group">
                                                  ...
                                                  {data?.inputType === "radio" ? (
                                                    data?.option?.map(
                                                      (item, index) => (
                                                        <div className="slt-opt" key={index}>
                                                          <input
                                                            type={data?.inputType}
                                                            name={data?.label}
                                                          />
