...
const TemplateOne = ({children}) => {
  ...
  return (
    <div className="outer">
      <section className="webinarRegistrationBody">
        <div className="sec1">
          <div className="add_hcp_boxes">
           {
            formData?.content?.headerImageUrl  &&           <TemplateOneHeader  imageUrl={formData?.content?.headerImageUrl}/>
      ...
      <TemplateOneFooter imageUrl={formData?.content?.footerImageUrl} />
...
const TemplateOneHeader=({imageUrl})=>{
...
const TemplateOneFooter=({imageUrl})=>{
