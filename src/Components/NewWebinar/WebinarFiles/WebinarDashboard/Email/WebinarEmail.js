                              ...
                              <div className="mail-stats">
                                <ul>
                                  ...
                                  <li>
                                    ...
                                    <span>
                                      {(data?.labels_value[Object.keys(data?.labels_value)[0]] > 0 && data?.email_sent > 0)
                                        ? ((data?.labels_value[Object.keys(data?.labels_value)[0]] / data?.email_sent) * 100)==100
                                        ?100 + "%"
                          ...
                          <div className="mail_click">
                            <div className="mail_click_box">
                              ...
                              <div className="mail_click_box_content">
                                ...
                                <span>{((ctrName[item] / viewEmailData?.email_sent) * 100)==100
                                ?100 + "%"
                              :((ctrName[item] / viewEmailData?.email_sent) * 100)==0
                              ?0
                              :((ctrName[item] / viewEmailData?.email_sent) * 100)?.toFixed(2)+"%"
