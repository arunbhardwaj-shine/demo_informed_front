...
import { getWebinarDraftData, getWebinarEmailData, getWebinarSelectedSmartListData } from "../../../../../actions/index";
                  ...
                  !deletestatus && (
                    <div className="email_box_block">
                      <div className="email-block-add">
                        <Link to="/webinar/email/create-new-email" onClick={createNewEmail}>
                                ...
                                {!deletestatus && (
                                  <div className="mailbox-buttons-list">
                                    ...
                                    <button
                                      ...
                                      onClick={() => {
                                        getWebinarEmailData(null);
                                        // getWebinarSelectedSmartListData(null);
                                        draftNavigate(
                                          data.id,
                                          data.pdf_id,
                                          data.route_location,
