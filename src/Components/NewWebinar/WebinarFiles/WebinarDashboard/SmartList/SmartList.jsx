...
const SmartList = (props) => {
  ...
  const handleDownload = async (list_id) => {
    const apiUrl = "https://webinar.docintel.app/lmn/api/distributes/download_smart_list_readers";
    const requestData = {
      user_id: localStorage.getItem("user_id"),
      list_id: list_id,
    };
    try {
      const response = await surveyAxiosInstance.post(apiUrl, requestData, {
        responseType: "blob",
      });
                      ...
                      <div className="smartlist_box_block new-smartlist" key={index}>
                        <div className="smartlist-view email_box">
                          <div className="mail-box-content">
                            ...
                            <SmartListLayout data= {data} iseditshow={editstatus} isviewshow={1} deletestatus={deletestatus} viewSmartListData = {viewSmartListData}  callLinkClickFun={linkClicked} webinarFlag={1} isDownloadEnable={downloadStatus} layout={'list'}/>
                            {deletestatus && (
