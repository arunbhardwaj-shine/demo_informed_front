            ...
            <div className="custom-container">
                <Row>
                      <div className='poll-creation'>
                          <Tabs
                              defaultActiveKey="questions" fill
                          >
                              <Tab
                                  eventKey="questions"
                                  title="Questions"
                                  ...
                                  <div className="question-listing-analytics speaker_zone">
                                      <div className="question-listing-analytics-left">
                                          <div className="webinar-top-sec d-flex justify-content-between align-center">
                                            <div className="top-heading"><h4>Questions | <span>6</span> </h4>
                                            </div>
                                          </div>
                                                        ...
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <p className="user_name">Octapharma</p>
                                                              <div className="question-post-time">
                                                                  <small>08:41 AM</small>
                                                              </div>
                                                        </div>
                                                        <div className="user-question">
                                                            <p>Guy this is Lina, please just one more short answer and then you can inform we will answer the rest off line. We still need to do a last poll</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                  <div className="reader_list">
                                      ...
                                      <div className="question-listing-analytics-right">
                                          <div className='answered'>
                                              <div className="webinar-top-sec d-flex justify-content-between align-center">
                                                <div className="top-heading"><h4>Send to Speaker | <span>3</span> </h4></div>
                                              </div>
                                                  <div className="speaker-zone-listed">
                                                    <div className="reader_list">
                                                        <div className="detail-box">
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <p className="user_name">Octapharma</p>
                                                              <div className="question-post-time">
                                                                  <small>07:22 AM</small>
                                                              </div>
                                                            </div>
                                                            <div className="user-question">
                                                                <p>Test comment to the speaker</p>
                                                            </div>
                                              ...
                                              <div className="speaker-zone-listed">
                                                <div className="reader_list">
                                                    <div className="detail-box">
                                                        ...
                                                        <div className="user-question">
                                                            <p>Hi guy this is lina - this is just a test</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                              ...
                              >
                                  ...
                                  <div className="question-listing-analytics speaker_zone">
                                      ...
                                      <div className="question-listing-analytics-right">
                                          <div className='answered'>
                                              <div className="webinar-top-sec d-flex justify-content-between align-center">
                                                  <div className="top-heading"><h4>Answered | <span>2</span> </h4></div>
                                              </div>
                                              <div className="speaker-zone-listed">
                                                  <div className="reader_list">
                                                      <div className="detail-box">
