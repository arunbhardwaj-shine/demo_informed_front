                        ...
                        <div className="email_stats_list d-flex align-items-end justify-content-between">
                          <div className="d-flex align-items-center">
                            <img
                              ...
                              alt="Export"
                            />{" "}
                            <p>{(viewEmailData?.read_percentage && viewEmailData?.read_percentage != "0.00%")
                      ...
                      {Object.keys(ctrName)?.length > 0 ? (
                        ...
                        <Col className="video-click ">
                          ...
                          <div className="email_stats_list d-flex align-items-end justify-content-between">
                            <div className="d-flex align-items-center">
                              <img
                                src={path_image + "video-click-banner.svg"}
                                alt="Export"
                              />{" "}
                              <p>{((ctrName[item] / viewEmailData?.email_sent) * 100)?.toFixed(0) + "%"}</p>
                            </div>
                            <div className="rd-box-export">
                              <img
                                src={path_image + "arrow-export.svg"}
