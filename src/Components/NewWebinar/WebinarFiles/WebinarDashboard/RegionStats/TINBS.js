...
const TINBS = () => {
  ...
  return (
    <>
    <div>
        <p>Total number of attendees in this region is 13</p>
        <p>6.28% (13/207) of total attendees</p>
        <p>0.83% (13/1560) of total registered</p>
    </div>
      <div>
