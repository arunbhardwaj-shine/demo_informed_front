...
const EU = () => {
  ...
  return (
    <>
    <div>
        <p>Total number of attendees in this region is 6</p>
        <p>2.90% (6/207) of total attendees</p>
        <p>0.38% (6/1560) of total registered</p>
    </div>
      <div>
