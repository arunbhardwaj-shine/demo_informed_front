...
const LATAM = () => {
  ...
  return (
    <>
    <div>
        <p>Total number of attendees in this region is 11</p>
        <p>5.31% (11/207) of total attendees</p>
        <p>0.71% (11/1560) of total registered</p>
    </div>
      <div>
