...
const MENA = () => {
  ...
  return (
    <>
    <div>
        <p>Total number of attendees in this region is 149</p>
        <p>71.98% (149/207) of total attendees</p>
        <p>9.55% (149/1560) of total registered</p>
    </div>
      <div>
