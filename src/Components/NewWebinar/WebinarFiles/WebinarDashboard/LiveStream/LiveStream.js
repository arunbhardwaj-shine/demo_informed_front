                            ...
                            return (<>
                              <div className="live-stream-ques">
                                ...
                                <div className='reader-message'>
                                  ...
                                  <p>If you want to divide the container into three equal portions using Bootstrap's grid system,
                                  ...
                                  within a row. Here's how you can modify your code:</p></div>
                                  <div className='user-comment'>
                                    <Form.Control size="lg" type="text" placeholder="Type your comment for the speaker here... " />
                                  </div>
                                </div>
