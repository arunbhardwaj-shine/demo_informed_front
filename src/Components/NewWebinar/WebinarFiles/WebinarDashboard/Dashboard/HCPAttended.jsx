...
const HCPAttended = () => {
  const [options1, setOptions1] = useState({
    ...
    title: {
      text: "HCP’s Attended By Country (207)",
    },
  ...
  const [options2, setOptions2] = useState({
    ...
    title: {
      text: "HCP’s Attended By Region (207)",
    },
    credits: { enabled: false },
    legend: {},
    minPointLength: 10,
  ...
  return (
    <>
      ...
      <div className="hcp-attended">
        <Row>
          <Col>
        <HighchartsReact
          className="attended-country"
          highcharts={Highcharts}
          options={options1}
        /></Col><Col>
        <HighchartsReact
          className="attended-region"
          highcharts={Highcharts}
          options={options2}
        /></Col>
        </Row>
