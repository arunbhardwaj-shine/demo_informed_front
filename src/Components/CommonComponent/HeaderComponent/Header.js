          ...
          <div className="container-fluid">
            ...
            <Navbar.Collapse id="collapsibleNavbar">
              ...
              <ul className="navbar-nav">
                ...
                {(localStorage.getItem("user_id") == "rjiGlqA9DXJVH7bDDTX0Lg==" || localStorage.getItem("user_id") == "B7SHpAc XDXSH NXkN0rdQ==" || localStorage.getItem("user_id") == "MXl8m36VZFYXpgFVz3Pg0g==")
