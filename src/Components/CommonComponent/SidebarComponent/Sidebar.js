                ...
                >
                  <div className="help-popup-content-inner">
                    <div className="help-popup-content-library library-p">
                      ...
                      <div className="help-popup-content-library-inside library-p publisher">
                        <p>
                          <strong>PdfId={selectedItem}
                             This page allows you to make changes to
                            your standard consent and pop-up texts
                          </strong>
                        </p>
                        <br />
                        <p>
                ...
                >
                  <div className="help-popup-content-inner">
                    <div className="help-popup-content-library library-p">
                      ...
                      <div className="help-popup-content-library-inside">
                        <p>
                          Start by filling in the information{" "}
                          <strong>
                            About the Docintel link you're making.
                          </strong>
                        </p>
                      </div>
                      <hr />
                      ...
                      <div className="help-popup-content-library-inside">
                        ...
                        <p>
                          <span>
                            You can save your content as a draft by selecting
                            “Yes” in the Draft button. 
                          </span>
                        </p>
                      </div>
                      <hr />
                      ...
                      <div className="help-popup-content-library-inside library-p publisher">
                        ...
                        <div className="help-popup-content-library-inside">
                          <p>
                            ...
                            <strong>Who is involved</strong> and if they can
                            print or download the sample.
                          </p>
                        </div>
                        <hr />
                        <div className="help-popup-content-library-inside">
                        ...
                        <div className="help-popup-content-library-inside">
                          <img
                            src={path_image + "select-cover-img.png"}
                            alt=""
                          />
                          <p>
                            <span>
                        ...
                        <div className="help-popup-content-library-inside">
                          <p>
                            ...
                            <br />
                            If you have any special requirements that are not
                            available here please open a ticket in the upper
                            right corner or email/call your inforMed.pro
                            contact.
                          </p>
                        </div>
                      </div>
                ...
                <div className="help-popup-content-inner">
                  <div className="help-popup-content-library library-p">
                    ...
                    <div className="help-popup-content-library-inside">
                      <p>
                        Start by filling in the information{" "}
                        <strong>About the Docintel link you're making.</strong>
                      </p>
                    </div>
                    <hr />
                    <div className="help-popup-content-library-inside">
