            ...
            <div className="timeline-layout">
              <div className="timeline-layout-inset">
                <div className="timeline-right-list">
                  ...
                  {showFilterBox && (
                    <div
                      style={{ display: "flex", border: "dotted", padding: 2 }}
                    >
                      <div>
                            ...
                            >
                              ...
                              {appliedFilter[key]?.length &&
                                appliedFilter[key]?.map((item, i) => {
                                  ...
                                  const isObj = totalData?.length > 0 && typeof totalData[0] === "object";
                                  let text = "";
                                  if (isObj) {
                                  ...
                                  const removeItem = () => {
                                    ...
                                    let filterdData = selectedData.filter(
                                      (itm) => itm !== item
                                    );
                                    setSelectedFilter({
                                      ...selectedFilter,
                      ...
                      <div style={{ marginLeft: "auto" }} onClick={clearFilter}>
                        Clear All
                      </div>
                    </div>
                  )}
