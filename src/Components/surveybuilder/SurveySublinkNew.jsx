 ...
 const navigate = useNavigate();
  ...
  const getSurveyData = async () => {
    try {
      ...
      const res = await surveyAxiosInstance.post(FETCH_SURVEY_DATA,{survey_id:0});
  ...
  const getSubLinkListingData = async (e, survey_id) => {
    ...
    try {
      const res = await surveyAxiosInstance.post(FETCH_SURVEY_SUBLINK, { survey_id });
                                ...
                                <Accordion>
                                  ...
                                  {data?.length > 0 ? (
                                      ...
                                      <div className="mail-box-content-top d-flex justify-content-between">
                                        <div className="mail-box-content-top-left">
                                          ...
                                          <div className="mailbox-tags">
                                            <ul>
                                              <li> {JSON.parse(item?.tags)?.length >
                                              0 ? (
                                          ...
                                          <div className="tab-content-links">
                                            ...
                                            <span
                                              ...
                                              onClick={() =>
                                                copyHandler(`https://survey.docintel.app/survey?Utmde=${item.unique_code}`)
                                              }
                                            >
                                              <img
                                                src={
                                          ...
                                          onClick={() => {
                                            ...
                                            setTimeout(function () {
                                              downloadQRCode(item?.survey_link_title);
                                            }, 500);
                                          }}
                                    ...
                                    <Accordion.Item eventKey={index}>
                                      <Accordion.Header onClick={(e)=>getSubLinkListingData(e,item.survey_id)}>
                                        SubLinks 
                                      </Accordion.Header>
                                      <Accordion.Body>
                                      ...
                                      <div className="d-flex justify-content-between align-items-center">
                                          <div className="sublink-title">
                                            <h6>SubLinks: : {subLinkData.length}</h6>
                                          </div>
                                          <Button className="btn-dashed" onClick={() => { showSublinkModal(item.survey_id); }} >
                                            Create New SubLink
                                            <img
                                              src={path_image + "add-icon.png"}
                                              alt="Plus"
                                            />
                                          </Button>
                                        </div>
                                    ...
                                    <div className="mail-box-content">
                                      <div className="mail-box-content-top">
                                        <div className="mail-box-content-top-left">
                                          ...
                                          <div className="tab-content-links">
                                            ...
                                            <span
                                              className="copy-content"
                                              onClick={() =>
                                                copyHandler(`https://survey.docintel.app/survey?Utmde=${subLink.unique_code}`)
                                              }
                                            >
                                              <img
                                                src={
                                            ...
                                            onClick={() => {
                                              ...
                                              setTimeout(function () {
                                                downloadQRCode(subLink?.identifier);
                                              }, 500);
                                            }}
                                            >
                                              <img
                                        ...
                                        <div className="mail-box-content-top-right">
                                          ...
                                          <div className="mailbox-buttons">
                                            <div className="send_new">
                                              <Button className="btn-bordered send-new" onClick={() => analyticButtonClicked(subLink,navigate,"true")}>
                                                Analytics
                                              </Button>
                                            </div>
                                            <div className="mailbox-buttons-list">
                                              <Button className="send btn-bordered">
                                                Edit Topic
                                              </Button>
                                            </div>
                                          </div>
