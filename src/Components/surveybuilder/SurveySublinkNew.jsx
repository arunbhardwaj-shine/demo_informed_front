                ...
                <div className="row">
                  <Col md={12}>
                    <div className="survey-sublink">
                      <h5>Primary Links | <span>4</span></h5>
                                ...
                                <div className="mail-box-content-top d-flex justify-content-between">
                                  <div className="mail-box-content-top-left">
                                    ...
                                    {/* <h5>{data?.survey_title}</h5>
                                            <p>{data?.subtitle}</p> */}
                                    <h5>Title Lorem ipsum dolorsit amet consectetur Orci </h5>
                                    <p>Subtitle klacerat proin aenean pretium id libero nulla</p>
                              ...
                              <div className="mail-box-acccordion">
                                <Accordion>
                                  <Accordion.Item eventKey="0">
                                    <Accordion.Header>SubLinks</Accordion.Header>
                                    <Accordion.Body>
                                        <div className="d-flex justify-content-between align-items-center">
                                          ...
                                          <Button className="btn-dashed">
                                            Create New SubLink
                                            <img src={path_image + "add-icon.png"} alt="Plus" />
                                          </Button>
                                        </div>
                                        <div className="mail-box-content">
