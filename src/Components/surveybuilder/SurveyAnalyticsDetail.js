...
const SurveyAnalyticsDetail = () => {
    ...
    let QuestionData=[
        ...
        ans:[
        {opt:"Masuismod phartra donec faucibus",value:8},
        {opt:"Masuismod phartra donec faucibus quisque nuneque",value:12},
        {opt:"Masuismod phartra donec faucibus quisque nuneque mote condi ment",value:15},
        {opt:"Masuismod phartra donec faucibus quisque",value:30},
        {opt:"Masuismod phartra donec faucibus quisque nuneque mote",value:108}
        ]
        },
        {
        ques:
        ...
        try {
            ...
            if (data != "undefined") {
                ...
                valueupdate.series = [
                    {
                        name: "Opened",
                        data: [{ y: data?.userOpenings, color: "#8a4e9c" }]
                    },
                    {
                        name: "Completed",
                        data: [{ y: data?.completed_count, color: "#ffbe2c" }]
                    },
                    {
                        name: "Drop-off",
                        data: [{ y: data?.Dropoff, color: "#ffbe2c" }]
                    }
                ];
                                                    ...
                                                    <div className="answer-options">
                                                        <div className="answer">
                                                            <div className="choices">
                                                                <span className="bullet-color" style={{ background: '#39CABC' }}>&nbsp;</span>
                                                        ...
                                                        <div className="answer">
                                                            <div className="choices">
                                                                <span className="bullet-color" style={{ background: '#FAC755' }}>&nbsp;</span>
                                                        ...
                                                        <div className="answer">
                                                            <div className="choices">
                                                                <span className="bullet-color" style={{ background: '#F58289' }}>&nbsp;</span>
                                                        ...
                                                        <div className="answer">
                                                            <div className="choices">
                                                                <span className="bullet-color" style={{ background: '#8A4E9C' }}>&nbsp;</span>
                                                        ...
                                                        <div className="answer">
                                                            <div className="choices">
                                                                <span className="bullet-color" style={{ background: '#0066BE' }}>&nbsp;</span>
