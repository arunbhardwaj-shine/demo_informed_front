...
//   useEffect(() => {
//     if (headingBoldFlag && editorRef.current) {
...
//           }
//         }}
//         initialValue={ headingBoldFlag ? `<strong>${editorValue}</strong>` : editorValue}
//         init={{
//           height: "120px",
//           branding: false,
//           menubar: false,
//           plugins: "link",
//           toolbar: "fontsize bold italic underline strikethrough | link forecolor",
//           content_style:
//             "body { font-family:Roboto,Helvetica,Arial,sans-serif; font-size:14px;color:#0066be;cursor: text; } body p img{width:100%;} body p{color:#0066be; margin: 2px 0;}, body *{margin:2px 0;}",
//           automatic_uploads: true,
//           image_caption: true,
...
//         }}
//         onEditorChange={(content) => {
//           setEditorValue(content); // Update the local state
//           handleUpdateElement(index, "question", content);
//         }}
//       />
//     </div>
