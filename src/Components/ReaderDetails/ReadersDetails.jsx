    ...
    if (url_id) {
      try {
        ...
        if (values?.notes?.length === 0) {
          ...
          setValue(
            "Notes",
            values?.notes ? values?.notes?.map((n) => ({ value: n })) : []
          );
        }
                        ...
                        <Form.Control
                          ...
                          {...register("middleName", {
                            maxLength: {
                              value: 255,
                              message:
                                "Middle name cannot exceed 255 characters",
                            },
                          })}
                        />
                        {errors?.middleName && (
                      ...
                      <Form.Group as={Col}>
                        ...
                        <Form.Control
                          ...
                          {...register("lastName", {
                            ...
                            validate: (value) =>
                              value.trim() !== "" ||
                              "Last name cannot be empty or spaces only",
                          })}
                        />
                        {errors?.lastName && (
                          <p className="error" style={{ color: "#db0000" }}>
                        ...
                        <Form.Control
                          ...
                          {...register("hospital", {
                            maxLength: {
                              value: 255,
                              message:
                                "Hospital name cannot exceed 255 characters",
                            },
                          })}
                        />
                        {errors.hospital && (
                        ...
                        <Form.Control
                          ...
                          {...register("title", {
                            maxLength: {
                              value: 200,
                              message:
                                "Title name cannot exceed 255 characters",
                            },
                          })}
                        />
                        {errors.title && (
                        ...
                        <Form.Control
                          ...
                          {...register("repContact", {
                            maxLength: {
                              value: 200,
                              message:
                                "repContact cannot exceed 255 characters",
                            },
                          })}
                        />
                        {errors.repContact && (
                          <p className="error" style={{ color: "#db0000" }}>
                            {errors.repContact.message}
                          </p>
                        )}
                      </Form.Group>
                          ...
                          >
                            <textarea
                              {...register(`Notes.${index}.value`, {
                                ...
                                validate: (value) => {
                                  if (!watch(`Notes.${index}.value`))
                                    return true; // Check if there was an initial value
                                  return (
                                    value.trim() !== "" ||
                                    "Text area cannot be empty or spaces only"
                                  );
                                },
                              })}
                              onChange={() =>
                                clearErrors(`Notes.${index}.value`)
