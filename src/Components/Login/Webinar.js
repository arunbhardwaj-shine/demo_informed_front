...
const Webinar = () => {
  ...
  <a href="#section08"><span></span><span></span><span></span>Scroll</a>
      ...
      <section className="blank-space">
       ...
       <section className="common" idd="66" id="request_demo" data-anchor="section6">
                  ...
                  <form className="form-horizontal" >
                           ...
                           <div className="form-left-fields">
                              <div className="form-group">
                                 <input type="text" id="name" className="contact-field" placeholder="Name" />
                              </div>
                              <div className="form-group">
                                 <input type="email" id="email" className="contact-field" placeholder="Email" />
                              </div>
                              <div className="form-group">
                                 <input type="number" id="phone" className="contact-field" placeholder="Contact Number" />
                              </div>
                              <div className="form-group">
                                 <input type="text" id="company" className="contact-field" placeholder="Company"/>
                              </div>
                              <div className="form-group select-option input-group">
                                 <select className="form-control contact-field" id="country">
                           ...
                           <div className="form-right-fields">
                              <div className="form-group input-group">
                                 <textarea className="form-control" rows="8" id="comment" placeholder="Comments"></textarea>
                              </div>
                           </div>
                           <img src="<?php INFORMEDPROURL;?>img/loader.gif" width="50" id="contact-form-loader" style={{display:"none"}}/>
                           <button type="button" id="contact-button" onClick="submitContactForm()" className="btn btn-default requst-demo">Request Demo</button>
                           <p className="alert alert-success" style={{display:"none",marginTop:"15px"}} id="contact-success-msg"> Thank you for contacting us. We will get back to you shortly. </p>
                            <p className="alert alert-danger" style={{display:"none",marginTop:"15px"}} id="contact-error-msg">  </p>
                        </form>
                      </div>
                  </div>
                </div>
      ...
      >
        <div className="copyright">
          <ul>
            ...
            <li>
              <a href="javascript:;" onClick={(e) => handleShow("privacy")} >Privacy Policy</a>
            </li>
