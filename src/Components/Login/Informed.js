      ...
      <div className="informed">
        <Navbar expand="lg" className="informed-nav">
          <Container>
            <Navbar.Brand href="#home">
              <img src="https://informed.pro/componentAssets/images/inforMed_Logo_Blue_1.svg" />
            </Navbar.Brand>
            ...
            <Row>
              <Col sm={7}>
                <div className="banner-infographic">
                  <div className="infographic text-right ">
                    <img
                      src="https://informed.pro/componentAssets/images/top-line.png"
                      className="line-shape text-right"
                      alt=""
                    />
                    <div className="dt-line">
                      <span className="dt-line-dote">
                        <img
                          src="https://informed.pro/componentAssets/images/top-dot.png"
                          className="line-dot text-right"
                          alt=""
                          id="first-img"
                        />
                      </span>
                  ...
                  <div className="bnr-img">
                    <img
                      src="https://informed.pro/componentAssets/images/top-infographic-1.png"
              ...
              <Col sm={5}>
                <div className="banner-content">
                  ...
                  <h4>
                    We link content and consent with individual behaviours to
                    drive insight and future actions on a personal level,
                    resulting in ever greater effectiveness for your
                    communication.{" "}
                  </h4>
                </div>
              </Col>
        ...
        <section className="library-section">
          <Container>
            <div className="dotted-line">
              <img
                src="https://informed.pro/componentAssets/images/bnr2-line-new.png"
                alt=""
              />
              <div className="dt-line r-none">
                <span className="dt-line-dote">
                  <img
                    src="https://informed.pro/componentAssets/images/bnr2-0line-new.png"
            ...
            <Row className="content-sec desktop">
              <Col sm={3}>
                <ul className="library-list">
                  <li>
                    <img
                      src="https://informed.pro/componentAssets/images/librery-icon-new.png"
                      alt=""
                    />
                  </li>
                  <li></li>
                  ...
                  <li>
                    <img
                      src="https://informed.pro/componentAssets/images/behaviour.png"
                      alt=""
                    />
                  </li>
                  <li>
                    <img
                      src="https://informed.pro/componentAssets/images/share-icon.png"
                      alt=""
                    />
                  </li>
                </ul>
              ...
              <Col sm={9}>
                <div className="content-part c-p1">
                  ...
                  <p>
                    The inforMed Library hosts all your content which can be
                    distributed to Clinicians across all channels. And secures
                    their continued consent.
                  </p>
                  <ul className="feature-list shift_left">
                    <li>
                      <img
                        src="https://informed.pro/componentAssets/images/list-icon1.png"
                        alt=""
                      />
                      <p>Articles</p>
                    </li>
                    <li>
                      <img
                        src="https://informed.pro/componentAssets/images/list-icon2.png"
                        alt=""
                      />
                      <p>Web pages</p>
                    </li>
                    <li>
                      <img
                        src="https://informed.pro/componentAssets/images/list-icon3.png"
                        alt=""
                      />
                      <p>EBooks</p>
                    </li>
                    <li>
                      <img
                        src="https://informed.pro/componentAssets/images/list-icon4.png"
                        alt=""
                      />
                      <p>CME/CPD</p>
                    </li>
                    <li>
                      <img
                        src="https://informed.pro/componentAssets/images/list-icon5.png"
                        alt=""
                      />
                      <p>Video</p>
                    </li>
                    <li>
                      <img
                        src="https://informed.pro/componentAssets/images/list-icon6.png"
                        alt=""
                      />
                      <p>Combinations</p>
                    </li>
                  ...
                  <div className="feature-list-next-content">
                    <p>
                      <span>
                        <img
                          src="https://informed.pro/componentAssets/images/saleforce-plus.png"
                          alt=""
                        />
                      </span>
                      <a href="https://appexchange.salesforce.com/appxListingDetail?listingId=a0N3A00000FHBQ4UAP">
                        <img
                          src="https://informed.pro/componentAssets/images/sale-icon.png"
                          alt=""
                        />
                      </a>
                ...
                <div className="content-part c-p2 behaviour">
                  ...
                  <p>
                    <span>
                      Do you know how much each of your Clinicians read?
                    </span>
                  </p>
                  <p>
                    We build profiles for every Clinician based on their actual
                    <br /> behaviour, so you can tailor content and channels
                    accordingly.
                  </p>
                  <div className="content-part height_up actions">
                    ...
                    <p>
                      <span>
                        What do you currenlty learn from Clinicians engagement?
                      </span>
                    </p>
                    <p>
                      Through detailed analysis you can target key groups. Use
                      our SmartLists for
                      <br /> emails, the inforMedGO app for in person or
                      Docintel Codes. Or link content
                      <br /> anywhere online or with any 3rd party tools.
                    </p>
                  </div>
                  <div className="content-part personalisation">
                    <ul>
                      <li className="personalisation-right">
                        <img
                          src="https://informed.pro/componentAssets/images/personalize.png"
                          alt=""
                        />
                      </li>
                    </ul>
                    <div className="personalisation-content">
                      ...
                      <p>
                        When you know what each Clinician reads or ignores, you
                        can tailor messaging so it is more likely to be read or
                        viewed, making them feel more engaged.{" "}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <ul className="library-list">
                ...
                <li>
                  ...
                  <div className="content-part c-p2 behaviour">
                    ...
                    <p>
                      We build profiles for every Clinician based on their
                      actual
                      <br /> behaviour, so you can tailor content and channels
                      accordingly.
                    </p>
          ...
          <Container className="padding_righttt">
            <div className="d-content">
              <div className="d-content-inr">
                <h5>
                  Doctors access your content through Docintel.app.
                  <br /> The apps become each clinician's own library of
                  content.
                </h5>
                <a
                  href="https://itunes.apple.com/us/app/docintel/id1459624369?ls=1&amp;mt=8"
                  target="_blank"
                  className="d-btn"
                >
                  Download Here
              ...
              <img
                className="modify_img_path"
                src="https://albert.docintel.app/static/images/All_Logo.png"
                alt=""
              />{" "}
            </div>
          </Container>
        ...
        <section className="rtr-section">
          <Container>
            <div className="dotted-line">
              <img
                src="https://informed.pro/componentAssets/images/bnr3-line.png"
                alt=""
              />
              <div className="dt-line r-none">
                <span className="dt-line-dote">
                  <img
                    src="https://informed.pro/componentAssets/images/bnr3-0line.png"
                    className="text-right"
                    alt=""
                  />
                </span>
            ...
            <Row className="content-sec top-space">
              <Col className="albert-inside-upper">
                <div className="albert-inside-upper-left">
                  <div className="albert-inside-upper-left-logo">
                    <img
                      src="https://informed.pro/componentAssets/images/docintel-white-tag.png"
                      alt=""
                    />
                  </div>
                  <p>
                    Docintel is a personal library for Clinicians to keep all
                    the materials they receive from you. Clinicians can control
                    and adjust their consent settings as well as record their
                    CPD.{" "}
                  </p>
                </div>
                <div className="albert-inside-upper-right">
                  <img
                    src="https://informed.pro/componentAssets/images/docintel-white-mobile-new.png"
                    alt=""
                  />
                </div>
              </Col>
              <Col md={12} className="albert-inside-bottom">
                <div className="albert-inside-bottom-left">
                  <img
                    src="https://informed.pro/componentAssets/images/docintel-white-left-mobile.png"
                    alt=""
                  />
                </div>
                <div className="albert-inside-bottom-right">
                  <h3>
                    Docintel also hosts <span>Albert the AI</span>
                  </h3>
                  <p>
                    Albert reads all new abstracts as they are released, sorts
                    them into 40 specialities and rates each for Clinical value,
                    making it easier for Clinicians to stay informed on their
                    relevant expertise.{" "}
                  </p>
                </div>
              </Col>
              <Col md={12} className="rtr-detial">
                <ul className="feature-list">
                  <li className="cr-flow">
                    {" "}
                    <img
                      src="https://informed.pro/componentAssets/images/rtr-icon1.png"
                      alt=""
                    />
                  ...
                  <li>
                    <img
                      src="https://informed.pro/componentAssets/images/rtr-icon2.png"
                      alt=""
                    />
                  ...
                  <li className="cr-flow c-f2">
                    <img
                      src="https://informed.pro/componentAssets/images/rtr-icon3.png"
                      alt=""
                    />
                  ...
                  <li>
                    <img
                      src="https://informed.pro/componentAssets/images/rtr-icon4.png"
                      alt=""
                    />
                ...
                <div className="rtr-section-contents">
                  ...
                  <p>
                    Docintel monitors Clinicians individual RTR. This industry
                    first Natural Language Processing tool analyses what
                    Clinicians read, page by page and what they ignore.
                  </p>
                </div>
              </Col>
            </Row>
        ...
        <section className="team-section">
          <Container>
            <div className="dotted-line">
              <img
                src="https://informed.pro/componentAssets/images/bnr4-line-new.png"
                alt=""
              />
              <div className="dt-line r-none">
                <span className="dt-line-dote">
                  <img
                    src="https://informed.pro/componentAssets/images/bnr4-0line-new.png"
                    alt=""
                  />
                </span>
              </div>
            ...
            <Row className="content-sec">
              <Col md={{ span: 9, offset: 3 }} className="content-sec-left">
                <div className="quick-text">
                  <div className="quick-inr">
                    <h2>
                      Get your team <br />
                      <span>started quickly!</span>
                    </h2>
                    <p>
                      An inforMed.pro account can be set up in under a month.
                      <br /> Enabling all your content to be housed with full
                      compliance in
                      <br /> one space. Letting your team distribute and gain
                      the power
                      <br /> that comes with Clincian consent and any
                      complaince.
                    </p>
                  </div>
                </div>
              ...
              <Col
                md={{ span: 11, offset: 1 }}
                className="no-padding team-section-map-listing"
              >
                <ul className="date-list">
                  ...
                  <li>
                    <h5>
                      ...
                      <span>Faster Prescriptions</span>
                    </h5>
                    <div>
                      <p>
                        Start having applying AI with
                        <br /> our Prediction AI engine
                      </p>
                    </div>
                  </li>
                </ul>
                ...
                <div className="start-building-gdpr">
                  <div className="start-building-gdpr-content">
                    <div className="start-building-gdpr-left">
                      <img
                        src="https://informed.pro/componentAssets/images/build-flag.png"
                        alt=""
                      />
                    </div>
                    <div className="start-building-gdpr-right">
                      <h4>
                        Start building your GDPR compliant library, distribute
                        across all channels and help your team predict doctors'
                        path to prescriptions
                      </h4>
                    </div>
                  </div>
                </div>
              ...
              <Col md={4}>
                <div className="contact-left">
                  ...
                  <div className="mob-img">
                    <img
                      src="https://informed.pro/componentAssets/images/contact-mobile.png"
                      alt="img-here"
