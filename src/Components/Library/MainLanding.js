                            ...
                            <Row>
                                <Col md="6">
                                    <div className="form-group">
                                        ...
                                        <span><img src={path_image + "user-icon.svg"} alt="" /></span>
                                    </div>
                                </Col>
                                <Col md="6">
                                    <div className="form-group">
                                        <input type="email" placeholder='Email' name="email" class="form-control"/>
                                        <span><img src={path_image + "email-icon2.svg"} alt="" /></span>
                                    </div>
                                </Col>
                                <Col md="6">
                                    <div className="form-group">
                                        <Select
                                            ...
                                            />
                                            <span><img src={path_image + "country-globe.svg"} alt="" /></span>
                                    </div>
                                </Col>
                                <Col md="6">
                                    <div className="form-group">
                                        <input type="text" placeholder='Company' name="company" class="form-control"/>
                                        <span><img src={path_image + "building-icon.svg"} alt="" /></span>
                                    </div>
                                </Col>
                                <Col md="12">
                                    <div className="form-group">
