  ...
  return (
   <>
    <div className='informed'>
                        ...
                        <Nav className="ms-auto justify-content-end">
                            ...
                            <NavDropdown title="Login">
                                <Form onSubmit={handleLogin}>
                                    ...
                                    <p onClick={(e) => handleShow("forgot")} className="go-btn">Forgot password?</p>
                                </Form>
                            </NavDropdown>
                        </Nav>
                </Navbar.Collapse>
            ...
            <Container>
                <Row>
                    ...
                    <div className="banner-content-video">
                        <div className="banner-content-video-popup" onClick={(e) => handleShow("video")} id="playVideo">
        ...
        <footer>
        <p>Copyright 2021
            <a href="https://informed.pro/" > InforMed.Pro</a>. Read our <a href="javascript:;" onClick={(e) => handleShow("privacy")}> privacy policy</a>.
        </p>
        </footer>

        <Modal show={videoPopupshow} onHide={(e) => handleClose("video")} className='video_modal'>
