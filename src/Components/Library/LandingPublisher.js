        ...
        <Container>
            <Row>
                <div className='landing-block'>
                    ...
                    <div className='landing-sub-heading'><h4>Simplify complexity using the most advanced platform made for the medical publishing industry, ensuring the security of your content. </h4></div>
            ...
            <Row>
                ...
                <Col md={{ span: 6, offset: 1 }} className='d-flex justify-content-center align-items-center'>
                    <div className='how-work-text'>
                        ...
                        <h5>Upload and create an eprint in 2 minutes from your own account. Your clients distribute and you see the usage in real-time and as they approach predefined limits you will be alerted.</h5>
                    </div>
                </Col>
            </Row>
            <Row>
                <div className='future-expand'>
                    ...
                    <h5>Say yes to more of your clients requests. With a decade of eprints in our system we’ve seen it all and solved more. With a universe of included tools you can help your clients achieve success. Allow us to demonstrate why our service continues to garnered enthusiastic praise from clients.</h5>
                </div>
            </Row>
        </Container>
    </div>
            ...
            <Row>
                <div className="consent-content-inner">
                    <div className="consent-text">
                        <h5>Docintel & inforMed.pro is 2 parts of a unified system. Create and set limits in inforMed.pro and let your clients use the free tools for distribution. Doctors engage with content using Docintel on any device of their choice. Usage and limits are monitored making life and reporting easier for you.</h5>
                    </div>
                ...
                <div className='works-started'>
                    <div className='works-started-links pharm-page'>
                        <h3>Modules </h3>
                        <h5>Click on a module to explore its capabilities and discover how it can benefit you. Learn about its connections with other modules and how they collectively help your clients succeed. These modules have been collaboratively developed with the publishers and are now integral parts of our comprehensive offerings aimed at enhancing your workflow.</h5>
                    </div>
                    <div className="modules-diagram publish">
                        <div className="circle" style={{'--total': "9"}}>
                            ...
                            <div className="stat informed" style={{'--i':"7"}}><img src={path_image+ "informedgo-icon.svg"}alt="" /><span>inforMedGo</span></div>
                            <div className="stat web" style={{'--i':"8"}}><img src={path_image+ "web-portal-icon.svg"}alt="" /><span>Web Portal</span></div>
                            <div className="stat webinar" style={{'--i':"9"}}><img src={path_image+ "webinar-small-icon.svg"}alt="" /><span>Webinar Portal</span></div>
