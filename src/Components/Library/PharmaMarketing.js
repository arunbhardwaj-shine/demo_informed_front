            ...
            <div className="landing-block">
              ...
              <div className="landing-sub-heading">
                <h4>
                  ...
                  Allowing the right materials, to reach the right person, at
                  the right time
                </h4>
              </div>
                ...
                >
                    ...
                    >
                     ...
                     {!showBigCircleData && (
                      ...
                      <Form>
                        ...
                        <p>Please tell us what you would like to know more about.</p>
                        <Row>
                          <Col md="12">
                              <div className="form-group">
                              ...
                              {!formFeilds && (
                                 ...
                                 <FormLabel>If you want to enter new contact details <span onClick={handleFormClick}>Click here</span></FormLabel>
                               </div>
                              )}
                  ...
                  {!showBigCircleData && (
                    ...
                    >
                      ...
                      <div className="stat blank" style={{ "--i": "10" }}></div>
                      <div className="stat blank" style={{ "--i": "11" }}></div>
                      ...
                      <div className="stat blank" style={{ "--i": "20" }}></div>
                      <div className="stat blank" style={{ "--i": "21" }}></div>
                      <div className="stat blank" style={{ "--i": "22" }}></div>
        ...
        <Container>
          <Row>
            <div className="contact-inset">
              <h3>Contact Us</h3>
              <h5>
                We're always happy to talk to you and answer any questions you
                have. You might have a question about something not covered on
                the page, something about compliance or other requests. <br />
                Please let us know what it is and who you are so we can get back
                to you right away.
              </h5>
          ...
          <Row>
            <div className="footer-inset">
              ...
              <div className="copyright">
                <p>
                  Copyright MedArkive Ltd 2023. Read our{" "}
            ...
            <FormGroup>
              <div className="form-check">
                <input
                  ...
                  id="check-remember"
                />
                <label className="form-check-label" for="check-remember">
                  Remember me
                </label>
              </div>
            </FormGroup>
