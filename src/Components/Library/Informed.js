                ...
                <Navbar.Brand href="#home"><img src={path_image + "inforMed_Logo_Blue_1.svg"}/></Navbar.Brand>
                    ...
                    <Navbar.Collapse id="informed-login">
                        <Nav className="ms-auto justify-content-end">
                            {/* <Nav.Link href="/publisher-page">Publisher</Nav.Link> */}
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
            <div className="privacy_policy_modal">
				...
				<ol start="a" className='list-alpha'>
                <li>name;</li>
                <li>date of birth;</li>
                <li>gender;</li>
                <li>job title;</li>
                ...
                <p dir="ltr">MedArkive will retain personal data for as long as necessary to fulfil our aim of improving content provided to you.</p>
                <ol start="7">
                <li dir="ltr">
