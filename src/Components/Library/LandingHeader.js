            ...
            <Form onSubmit={handleLogin}>
                <FormGroup>
                    <div className="form-group error">
                        ...
                        placeholder="Email"
                        value={username}
                        onChange={(event) => {setUsername(event.target.value); setShowUserNameError(null)}}
                    ...
                    {showUserNameError && <p style={{ color: "red" }}>{showUserNameError}</p>}
                </FormGroup>
                
                <FormGroup>
                    <div className="form-group pass error">
                        <input
                        type="password"
                        name="password"
                        placeholder="Password"
                        value={password}
                        onChange={(event) => {setPassword(event.target.value); setShowPasswordError(null)}}
                        className="form-control" />
