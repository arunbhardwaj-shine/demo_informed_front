   ...
   const data = [
    {
      ...
      lex_p: "Lorem sollicitudin faucibus eu molestie sollicitudin gulvinar ultricies neque prae..",
            ...
            <div className='rd-analytics-content'>
                          ...
                          <div className='rd-analytics-box-layout'>
                              <div className='rd-analytics-top d-flex justify-content-between align-items-center'>
                                ...
                                <div className='d-flex'>
                                    <div className='count-number'>35</div>
                              ...
                              <div className='graph-box'>
                                ...
                                <img className="pie-chart" src={path_image + "pie-chart.png"} alt="" />
                              </div>
                        ...
                        <div className='rd-analytics-box non-mandatory'>
                          ...
                          <div className='rd-analytics-box-layout'>
                              ...
                              <div className='graph-box'>
                                ...
                                <img className="graph-chart" src={path_image + "graph-chart1.png"} alt="" />
                              </div>
                              <div className='rd-box-export'>
                                <img src={path_image + "arrow-export.svg"} alt="" />
                              </div>
                      ...
                      <div className='rd-analytics-box-layout'>
                          ...
                          <div className='graph-box'>
                            ...
                            <div className='lex-article'>
                                   {data.map((item, index) => (
                                    <div key={index} className='d-flex lex-article-box'>
                                      <div className='lex-image'>
                                        <div className='article-number'>{item.article_number}</div>
                                      ...
                                      <div className='lex-detail'>
                                        ...
                                        <div className='d-flex justify-content-between'>
                                          <div className='pages-number'>
                                           {item?.pages_number?"Pages:":"Time:"}<span>{item?.pages_number?item.pages_number:item?.video_time}</span>
                                          </div>
                                          <div className='pages-viewer'>
                                            {item.pages_viewer} <img src={path_image + "viewer.svg"} alt="" />
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                             ...
                             <div className=''>
                                  <p>Sites who Read | Watch the <span>1 top</span> content</p>
                                  <span>Click on the graph to see more details</span>
                              </div>
                  ...
                  <div className='rd-training-block'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <div className='rd-training-block-left'>
                        <h4>Individual Completion | <span>35</span></h4>
                    ...
                    <Table class="fold-table">
                      <thead>
                        <tr>
                          <th>Name</th><th>Role</th><th>Blind type</th><th>Training</th><th>Site</th><th>&nbsp;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className={`view ${show && show =="1"? "show" : ""}`}  onClick={() => setShow("1")}>
                          <td>UserName</td>
                          <td>Role name</td>
                          <td>Blinded</td>
                          <td className="complete">Completed</td>
                          <td>Site name</td>
                          <td class="pics"><img src={path_image + "certificate.png"} alt="Certificate" /></td>
                        </tr>
                        <tr className={`fold ${show && show =="1"? "show" : ""}`}>
                          <td colspan="6">
                                ...
                                <Accordion.Item eventKey="0">
                                      ...
                                      <div className='content-detail'>
                                        ...
                                        <div className='page-count'>
                                          ...
                                          <div className='completed-date'>
                                            Completed date<span className='complete'>1 Jan 2023 <img src={path_image + "check-complete.svg"} alt="" /></span>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div className='article-pages-details d-flex'>
                                      <div className='article-page-show'>
                                        <div className='article-cover-img'>
                                          <img src={path_image + "article-content-cover.png"} alt="" />
                                        </div>
                                        <div className='article-detail-view'>
                                          <div className='article-page-number'>
                                           ...
                                           <div className='article-spanrd-time'>
                                              Time spent | <span>5<small>sec</small></span>
                                           </div>
                                        </div>
                                      </div>
                                      <div className='article-page-show'>
                                 ...
                                 <Accordion.Item eventKey="1">
                                  <Accordion.Header>
                                    <div className='d-flex align-items-start'>
                                      <div className='content-image'>
                                        <img src={path_image + "article-video-cover.png"} alt="" />
                                      </div>
                                      <div className='content-detail'>
                                        <h6>Lorem sollicitudin faucibus eu molestie sollicitudin gravi ulvinar ultricies neque praesent maurircu aliquam ondi ment zcsum nudolor nibhcudolor ..</h6>
                                        <p>Lorem sollicitudin faucibus eu molestie sollicitudin gravida</p>
                                  ...
                                  <Accordion.Body>
                                    <div className='article-pages-details d-flex'>
                                      <div className='article-page-show'>
                                        <div className='article-cover-img'>
                                          <img src={path_image + "article _cover_video.png"} alt="" />
                                        </div>
                                        <div className='article-detail-view'>
                                          <div className='article-page-number'>
                                            Video
                                           ...
                                           <div className='article-spanrd-time'>
                                              Time spent | <span>12<small>minutes</small></span>
                                           </div>
                                        </div>
                                      </div>
                                      <div className='article-page-show'>
                                        ...
                                        <div className='article-detail-view'>
                                          <div className='article-page-number'>
                                           ...
                                           <div className='article-spanrd-time'>
                                              Time spent | <span>5<small>minutes</small></span>
                                           </div>
                                        </div>
                                      </div>
                                    </div>
                                 ...
                                 <Accordion.Item eventKey="2">
                                  <Accordion.Header>
                                    <div className='d-flex align-items-start'>
                                      <div className='content-image'>
                                        <img src={path_image + "certificate-cover.png"} alt="" />
                                      </div>
                                      <div className='content-detail'>
                                        <h6>Certificate</h6>
                                        <p>Lorem sollicitudin faucibus eu molestie sollicitudin gravida</p>
                                        <div className='page-count'>
                                          ...
                                          <div className='completed-date'>
                                            Issued date <span className='complete'>2 Jan 2023  <img src={path_image + "check-complete.svg"} alt="" /></span>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                        ...
                        <tr className='blank'><td colspan="6" style={{height:"10px;"}}>&nbsp;</td></tr>
                        <tr className={`view ${show && show =="2"? "show" : ""}`}  onClick={() => setShow("2")}>
                          <td>UserName</td>
                          <td>Role name</td>
                          <td>Blinded</td>
                        ...
                        <tr className={`fold ${show && show =="2"? "show" : ""}`}>
                          <td colspan="6">
                            <div className="fold-content">
                              <p>Completed Contents | <span>2</span></p>
                              <span>Click on the content for more details</span> 
                                    ...
                                    <div className='d-flex align-items-start'>
                                      ...
                                      <div className='content-detail'>
                                        ...
                                        <div className='page-count'>
                                          ...
                                          <div className='completed-date'>
                                            Completed date<span className='started'>1 Jan 2023</span>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                        ...
                        <tr className='blank'><td colspan="6" style={{height:"10px;"}}>&nbsp;</td></tr>
                        <tr className={`view ${show && show =="3"? "show" : ""}`}     onClick={() => setShow("3")}>
                          <td>UserName</td>
                          <td>Role name</td>
                          <td>Blinded</td>
                        ...
                        <tr className={`fold ${show && show =="3"? "show" : ""}`}>
                          <td colspan="6">
                            <div className="fold-content">
                              <p>Completed Contents | <span>2</span></p>
                              <span>Click on the content for more details</span> 
                ...
                <div className='rd-full-explain'>
                  ...
                  <div className='rd-training-block'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <div className='rd-training-block-left'>
                        <h4>Site Completion | <span>20</span></h4>
                        <p></p>
                      </div>
                      <div className='rd-training-block-right d-flex'>
                          <Button title="Download stats">
                    ...
                    <Table class="fold-table">
                      <thead>
                        <tr>
                          <th className='site_name'>Site Name</th><th>Site Number</th><th>Country</th><th className='active-irt'>Active IRTs | Pharmacists</th><th>Completed Training</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className={`view ${show && show =="11"? "show" : ""}`}  onClick={() => setShow("11")}>
                          <td className='site_name'>Site name</td>
                          <td>00801-94</td>
                          <td>United Kingdom</td>
                          <td className='active-irt'><span>3</span> <img src={path_image + "doctor-svg.svg"} alt=""/></td>
                          <td className='complete'>2</td>
                        </tr>
                        <tr className={`fold ${show && show =="11"? "show" : ""}`}>
                          <td colspan="5" className='site_complete'>
                            <Table>
                              <thead>
                                <tr>
                                  <th>Name</th><th>Role</th><th>Blind Type</th><th>Training</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                                  <td>UserName</td><td>Role name</td><td>Blinded</td><td className='complete'>Completed</td>
                                </tr>
                                <tr>
                                  <td>UserName</td><td>Role name</td><td>Blinded</td><td className='complete'>Completed</td>
                                </tr>
                                <tr>
                                  <td>UserName</td><td>Role name</td><td>Blinded</td><td className='not_yet'>Not yet</td>
                                </tr>
                              </tbody>
                            </Table>
                          </td>
                        </tr>
                        <tr className='blank'><td colspan="5" style={{height:"10px;"}}>&nbsp;</td></tr>
                        <tr className={`view ${show && show =="12"? "show" : ""}`}  onClick={() => setShow("12")}>
                          <td className='site_name'>Site name</td>
                          <td>00801-94</td>
                          <td>United Kingdom</td>
                          <td className='active-irt'><span>16</span><img src={path_image + "doctor-svg.svg"} alt=""/></td>
                          <td className='complete'>14</td>
                        </tr>
                        <tr className={`fold ${show && show =="12"? "show" : ""}`}>
                          <td colspan="5" className='site_complete'>
                            <Table>
                              <thead>
                                <tr>
                        ...
                        <tr className='blank'><td colspan="5" style={{height:"10px;"}}>&nbsp;</td></tr>
                        <tr className={`view ${show && show =="13"? "show" : ""}`}  onClick={() => setShow("13")}>
                          <td className='site_name'>Site name</td>
                          <td>00801-94</td>
                          <td>United Kingdom</td>
                          <td className='active-irt'><span>12</span><img src={path_image + "doctor-svg.svg"} alt=""/></td>
                          <td className='complete'>4</td>
                        </tr>
                        <tr className={`fold ${show && show =="13"? "show" : ""}`}>
                          <td colspan="5" className='site_complete'>
                            <Table>
                              <thead>
                                <tr>
                ...
                <div className='rd-full-explain'>
                  ...
                  <div className='rd-training-block'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <div className='rd-training-block-left'>
                        <h4>Site Engagement | <span>8</span></h4>
                        <p>Click on the Record to see more details</p>
                      </div>
                      <div className='rd-training-block-right d-flex'>
                          <Button title="Download stats">
                    ...
                    <Table class="fold-table">
                      <thead>
                        <tr>
                          <th>Site</th><th>Site Number</th><th>Country</th><th>Site Users</th><th>Content engagement</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className={`view ${show && show =="31"? "show" : ""}`}  onClick={() => setShow("31")}>
                          <td>Site Name</td>
                          <td>00801-94</td>
                          <td>United Kingdom</td>
                          <td>4</td>
                        ...
                        <tr className={`fold ${show && show =="31"? "show" : ""}`}>
                          <td colspan="5">
                            <div className="fold-content">
                              <p>Content engagement | <span>2</span></p>
                              <span>Click on the content for more details</span> 
                        ...
                        <tr className='blank'><td colspan="5" style={{height:"10px;"}}>&nbsp;</td></tr>
                        <tr className={`view ${show && show =="32"? "show" : ""}`}  onClick={() => setShow("32")}>
                          <td>Site Name</td>
                          <td>00801-94</td>
                          <td>United Kingdom</td>
                          <td>4</td>
                        ...
                        <tr className={`fold ${show && show =="32"? "show" : ""}`}>
                          <td colspan="5">
                            <div className="fold-content">
                              <p>Completed Contents | <span>2</span></p>
                              <span>Click on the content for more details</span> 
                                ...
                                <Accordion.Item eventKey="0">
                                  <Accordion.Header>
                                    <div className='d-flex align-items-start engagement-sec'>
                                      ...
                                      <div class="pages-viewer">5 <img src="componentAssets/images/viewer.svg" alt=""/></div>
                                    </div>
                                  </Accordion.Header>
                                  <Accordion.Body>
                                    <div className='article-pages-details d-flex'>
                                ...
                                <Accordion.Item eventKey="10" className='accordion-read'>
                                  <Accordion.Header>
                                    <div className='d-flex align-items-center justify-content-center'>
                                      Who Read | Watched at each site <img src={path_image + "accordian_arrow.svg"} alt="" />
                                    </div>
                                  </Accordion.Header>
                                  <Accordion.Body>
                                    <div className='contents-block d-flex'>
                                        ...
                                        <Table>
                                          <thead>
                                                <tr>
                                                  <th>Site</th>
                                                  <th>Site Number</th>
                                                  <th className="short_value"><Button className='sort_btn'>
                                                        Sort By
                                                        <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                          <path d="M18.9214 11.7442C18.7651 11.588 18.5532 11.5002 18.3322 11.5002C18.1112 11.5002 17.8993 11.588 17.743 11.7442L14.9989 14.4884V1.50002C14.9989 1.27901 14.9111 1.06705 14.7548 0.910765C14.5985 0.754484 14.3866 0.666687 14.1655 0.666687C13.9445 0.666687 13.7326 0.754484 13.5763 0.910765C13.42 1.06705 13.3322 1.27901 13.3322 1.50002V14.4884L10.588 11.7442C10.4309 11.5924 10.2204 11.5084 10.0019 11.5103C9.78338 11.5122 9.57437 11.5998 9.41986 11.7543C9.26535 11.9088 9.17771 12.1179 9.17581 12.3364C9.17391 12.5549 9.25791 12.7654 9.40971 12.9225L13.5764 17.0892C13.6538 17.1668 13.7457 17.2284 13.847 17.2704C13.9482 17.3124 14.0568 17.334 14.1664 17.334C14.276 17.334 14.3845 17.3124 14.4858 17.2704C14.587 17.2284 14.679 17.1668 14.7564 17.0892L18.923 12.9225C19.079 12.766 19.1665 12.554 19.1662 12.333C19.1659 12.112 19.0778 11.9002 18.9214 11.7442Z" fill="#97B6CF"/>
                                                          <path d="M10.5892 5.0775L6.42251 0.91084C6.34489 0.833074 6.25253 0.771594 6.15084 0.730007C5.94698 0.645743 5.71803 0.645743 5.51417 0.730007C5.41248 0.771594 5.32011 0.833074 5.2425 0.91084L1.07583 5.0775C0.919572 5.23398 0.831875 5.44612 0.832031 5.66726C0.832188 5.88839 0.920184 6.10041 1.07666 6.25667C1.23314 6.41293 1.44528 6.50062 1.66642 6.50047C1.88756 6.50031 2.09957 6.41231 2.25583 6.25584L5 3.51167V16.5C5 16.721 5.0878 16.933 5.24408 17.0892C5.40036 17.2455 5.61232 17.3333 5.83334 17.3333C6.05435 17.3333 6.26631 17.2455 6.4226 17.0892C6.57888 16.933 6.66667 16.721 6.66667 16.5V3.51167L9.41085 6.25584C9.56801 6.40763 9.77852 6.49163 9.99701 6.48973C10.2155 6.48783 10.4245 6.40019 10.579 6.24568C10.7335 6.09118 10.8212 5.88217 10.8231 5.66367C10.825 5.44517 10.741 5.23467 10.5892 5.0775Z" fill="#97B6CF"/>
                                          ...
                                          <tbody>
                                            <tr>
                                              <td>Site Name</td>
                                              <td>00801-94</td>
                                              <td className="short_value">103 <img src="componentAssets/images/viewer.svg" alt=""/></td>
                                            </tr>
                                            <tr>
                                              <td>Site Name</td>
                                              <td>00801-94</td>
                                      ...
                                      <div className='contents-block-right'>
                                          ...
                                          <div className='used-device-detail'>
                                            <img src={path_image + "used-device-stats.png"} alt="" />
                                          </div>
                                      </div>
                                    </div>
                                  </Accordion.Body>
                                 ...
                                 <Accordion.Item eventKey="1">
                                  <Accordion.Header>
                                    <div className='d-flex align-items-start engagement-sec'>
                                      ...
                                      <div class="pages-viewer">1 <img src="componentAssets/images/viewer.svg" alt=""/></div>
                                    </div>
                                  </Accordion.Header>
                                  <Accordion.Body>
                                    <div className='article-pages-details d-flex'>
                                 ...
                                 <Accordion.Item eventKey="2">
                                  <Accordion.Header>
                                    <div className='d-flex align-items-start engagement-sec'>
                                      ...
                                      <div class="pages-viewer">2 <img src="componentAssets/images/viewer.svg" alt=""/></div>
                                    </div>
                                  </Accordion.Header>
                                  <Accordion.Body>
