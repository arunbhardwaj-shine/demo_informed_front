            ...
            <div className="top-header">
              <div className="page-title">
                ...
                <button className="btn btn-primary btn-bordered back">
                  <Link to="/license-create-user">Back</Link>
                </button>
              </div>
...
export default EditConsentOptions;
